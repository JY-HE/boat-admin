...
import type { BreadcrumbStyle } from '@/store';

const { breadcrumbStyle, setBreadcrumbStyle } = useSystemConfig();

const breadcrumbStyles = [
    {
        name: '默认',
        type: 'default' as BreadcrumbStyle,
    },
    {
        name: '现代',
        type: 'modern' as BreadcrumbStyle,
    },
];
</script>
